...
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIclassic, EVP_PKEY_RAINBOWICLASSIC, OID(0x2B, 0xCE, 0x0F, 0x05, 0x01, 0x01))

DEFINE_OQS_ASN1_METHODS(rainbowIcircumzenithal, OQS_SIG_alg_rainbow_I_circumzenithal, EVP_PKEY_RAINBOWICIRCUMZENITHAL)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIcircumzenithal, EVP_PKEY_RAINBOWICIRCUMZENITHAL, OID(0x2B, 0xCE, 0x0F, 0x05, 0x01, 0x04))

DEFINE_OQS_ASN1_METHODS(rainbowIcompressed, OQS_SIG_alg_rainbow_I_compressed, EVP_PKEY_RAINBOWICOMPRESSED)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIcompressed, EVP_PKEY_RAINBOWICOMPRESSED, OID(0x2B, 0xCE, 0x0F, 0x05, 0x01, 0x07))

DEFINE_OQS_ASN1_METHODS(rainbowIIIclassic, OQS_SIG_alg_rainbow_III_classic, EVP_PKEY_RAINBOWIIICLASSIC)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIIIclassic, EVP_PKEY_RAINBOWIIICLASSIC, OID(0x2B, 0xCE, 0x0F, 0x05, 0x02, 0x01))
...
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIIIcircumzenithal, EVP_PKEY_RAINBOWIIICIRCUMZENITHAL, OID(0x2B, 0xCE, 0x0F, 0x05, 0x02, 0x03))

DEFINE_OQS_ASN1_METHODS(rainbowIIIcompressed, OQS_SIG_alg_rainbow_III_compressed, EVP_PKEY_RAINBOWIIICOMPRESSED)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowIIIcompressed, EVP_PKEY_RAINBOWIIICOMPRESSED, OID(0x2B, 0xCE, 0x0F, 0x05, 0x02, 0x05))

DEFINE_OQS_ASN1_METHODS(rainbowVclassic, OQS_SIG_alg_rainbow_V_classic, EVP_PKEY_RAINBOWVCLASSIC)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowVclassic, EVP_PKEY_RAINBOWVCLASSIC, OID(0x2B, 0xCE, 0x0F, 0x05, 0x03, 0x01))

DEFINE_OQS_ASN1_METHODS(rainbowVcircumzenithal, OQS_SIG_alg_rainbow_V_circumzenithal, EVP_PKEY_RAINBOWVCIRCUMZENITHAL)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowVcircumzenithal, EVP_PKEY_RAINBOWVCIRCUMZENITHAL, OID(0x2B, 0xCE, 0x0F, 0x05, 0x03, 0x03))

DEFINE_OQS_ASN1_METHODS(rainbowVcompressed, OQS_SIG_alg_rainbow_V_compressed, EVP_PKEY_RAINBOWVCOMPRESSED)
DEFINE_OQS_PKEY_ASN1_METHOD(rainbowVcompressed, EVP_PKEY_RAINBOWVCOMPRESSED, OID(0x2B, 0xCE, 0x0F, 0x05, 0x03, 0x05))
